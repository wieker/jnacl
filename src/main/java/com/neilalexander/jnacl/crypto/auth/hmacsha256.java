...
public class hmacsha256 {
  ...
  public static int crypto_auth(byte[] out, byte[] in, int inlen, byte[] k) {
    ...
    if (inlen < 56) {
      ...
      padded[56] = (byte) (bits >> 56);
      padded[57] = (byte) (bits >> 48);
      padded[58] = (byte) (bits >> 40);
      padded[59] = (byte) (bits >> 32);
      padded[60] = (byte) (bits >> 24);
      ...
      padded[121] = (byte) (bits >> 48);
      padded[122] = (byte) (bits >> 40);
      padded[123] = (byte) (bits >> 32);
      padded[124] = (byte) (bits >> 24);
