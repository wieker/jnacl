...
//  }
  ...
  public static int crypto_auth_verify(int[] h, int[] in, int inlen, int[] k) {
    throw new UnsupportedOperationException("not yet implemented");
  }
//  public static int crypto_auth_verify(const unsigned char *h,const unsigned char *in,unsigned long long inlen,const unsigned char *k)
//  {
